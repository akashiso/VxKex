...
KXUSERAPI DPI_HOSTING_BEHAVIOR WINAPI GetWindowDpiHostingBehavior()
{
	return DPI_HOSTING_BEHAVIOR_DEFAULT;
}

KXUSERAPI DPI_HOSTING_BEHAVIOR WINAPI GetThreadDpiHostingBehavior()
{
	return DPI_HOSTING_BEHAVIOR_DEFAULT;
}

KXUSERAPI DPI_HOSTING_BEHAVIOR WINAPI SetThreadDpiHostingBehavior(DPI_HOSTING_BEHAVIOR newBehavior)
{
	return DPI_HOSTING_BEHAVIOR_DEFAULT;
}
