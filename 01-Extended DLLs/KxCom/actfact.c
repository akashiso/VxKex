	...
	OUT	PPVOID				Object)
{
	...
	*Object = NULL;
	...
	else if (IsEqualIID(RefIID, &IID_INetworkInformationStatics))
	{
		*Object = &CNetworkInformationStatics;
	}
	else if (IsEqualIID(RefIID, &IID_IDispatcherQueueControllerStatics))
	{
		*Object = &CDispatcherQueueControllerStatics;
	}
	else if (IsEqualIID(RefIID, &IID_IDispatcherQueueStatics))
	{
		*Object = &CDispatcherQueueStatics;
	}
	else if (IsEqualIID(RefIID, &IID_IGameBarStatics))
	{
		*Object = &CGameBarStatics;
	}
	else if (IsEqualIID(RefIID, &IID_IAccessibilitySettings))
	{
		*Object = &CAccessibilitySettings;
	}
	else if (IsEqualIID(RefIID, &IID_IInputPaneStatics))
	{
	...
	else if (IsEqualIID(RefIID, &IID_IInputPaneInterop))
	{
		*Object = &CInputPaneInterop;
	}
	else if (IsEqualIID(RefIID, &IID_IColorHelperStatics))
	{
	...
	else if (IsEqualIID(RefIID, &IID_IThreadPoolStatics))
	{
	...
	else if (IsEqualIID(RefIID, &IID_IApplicationLanguagesStatics))
	{
		*Object = &CApplicationLanguagesStatics;
	}
	else if (IsEqualIID(RefIID, &IID_ISmbiosInformationStatics))
	{
		*Object = &CSmbiosInformationStatics;
	}
	else if (IsEqualIID(RefIID, &IID_IHostNameFactory))
	{
		*Object = &CHostNameFactory;
	}
	else if (IsEqualIID(RefIID, &IID_IHostNameStatics))
	{
		*Object = &CHostNameStatics;
	}
	else
	{
		if (!KexIsDebugBuild)
