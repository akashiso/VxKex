...
// Windows.Globalization.ILanguage & ILanguage2

KXCOMAPI HRESULT STDMETHODCALLTYPE Language_QueryInterface(
	IN	ILanguage* This,
	IN	REFIID		RefIID,
	OUT	PPVOID		Object)
{
	...
	*Object = NULL;
	...
	if (IsEqualIID(RefIID, &IID_IUnknown) ||
		IsEqualIID(RefIID, &IID_IInspectable) ||
		IsEqualIID(RefIID, &IID_IAgileObject) ||
		IsEqualIID(RefIID, &IID_ILanguage))
	{
		*Object = This->Parent;
		InterlockedIncrement(&This->Parent->RefCount);
	}
	else if (IsEqualIID(RefIID, &IID_ILanguage2))
	{
		*Object = &This->Parent->cLanguage2;
		InterlockedIncrement(&This->Parent->RefCount);
	}
	else
	{
...
KXCOMAPI ULONG STDMETHODCALLTYPE Language_AddRef(
	IN	ILanguage* This)
{
	return InterlockedIncrement(&This->Parent->RefCount);
}

KXCOMAPI ULONG STDMETHODCALLTYPE Language_Release(
	IN	ILanguage* This)
{
	ULONG NewRefCount;
...
KXCOMAPI HRESULT STDMETHODCALLTYPE Language_GetIids(
	IN	ILanguage* This,
	OUT	PULONG		NumberOfIids,
	OUT	IID** IidArray)
{
	...
	*NumberOfIids = Count;
	Array[0] = IID_ILanguage;
	Array[1] = IID_ILanguage2;

	return S_OK;
}

KXCOMAPI HRESULT STDMETHODCALLTYPE Language_GetRuntimeClassName(
	IN	ILanguage* This,
	OUT	HSTRING* ClassName)
{
	PCWSTR Name = L"Windows.Globalization.ILanguage";
	ASSERT(ClassName != NULL);
	return WindowsCreateString(Name, (ULONG)wcslen(Name), ClassName);
}

KXCOMAPI HRESULT STDMETHODCALLTYPE Language_GetTrustLevel(
	IN	ILanguage* This,
	OUT	TrustLevel* Level)
{
	ASSERT(Level != NULL);
...
KXCOMAPI HRESULT STDMETHODCALLTYPE Language_get_LanguageTag(
	IN	ILanguage* This,
	OUT HSTRING* str)
{
	return WindowsCreateString(This->Name, (ULONG)wcslen(This->Name), str);
}

KXCOMAPI HRESULT STDMETHODCALLTYPE Language_get_DisplayName(
	IN	ILanguage* This,
	OUT HSTRING* str)
{
	if (str == NULL)
	...
	if (!GetLocaleInfoEx(This->Name, LOCALE_SLANGDISPLAYNAME,
...
KXCOMAPI HRESULT STDMETHODCALLTYPE Language_get_NativeName(
	IN	ILanguage* This,
	OUT HSTRING* str)
{
	if (str == NULL)
	...
	WCHAR Buffer[LOCALE_NAME_MAX_LENGTH];
	if (!GetLocaleInfoEx(This->Name, LOCALE_SNATIVELANGNAME,
						 Buffer, ARRAYSIZE(Buffer)))
		return E_FAIL;
...
KXCOMAPI HRESULT STDMETHODCALLTYPE Language_get_Script(
	IN	ILanguage* This,
	OUT HSTRING* str)
{
	if (str == NULL)
	...
	WCHAR Buffer[LOCALE_NAME_MAX_LENGTH];
	if (!GetLocaleInfoEx(This->Name, LOCALE_SSCRIPTS,
						 Buffer, ARRAYSIZE(Buffer)))
		return E_FAIL;
...
KXCOMAPI HRESULT STDMETHODCALLTYPE Language2_get_LayoutDirection(
	IN ILanguage* thiz,
	OUT LanguageLayoutDirection* out)
{
	if (out == NULL)
		return E_POINTER;

	DWORD Layout;
	if (!GetLocaleInfoEx(thiz->Parent->Name, LOCALE_IREADINGLAYOUT | LOCALE_RETURN_NUMBER,
						 (void*)&Layout, sizeof(Layout)))
		return E_FAIL;

	*out = (LanguageLayoutDirection)Layout;
	return S_OK;
}

ILanguageVtbl CLanguageVtbl = {
...
KXCOMAPI HRESULT STDMETHODCALLTYPE LanguageFactory_QueryInterface(
	IN	ILanguageFactory* This,
	IN	REFIID		RefIID,
	OUT	PPVOID		Object)
{
	ASSERT(This != NULL);
	...
	*Object = NULL;
	...
	if (IsEqualIID(RefIID, &IID_IUnknown) ||
		IsEqualIID(RefIID, &IID_IInspectable) ||
		IsEqualIID(RefIID, &IID_IAgileObject) ||
		IsEqualIID(RefIID, &IID_ILanguageFactory))
	{
		*Object = This;
	}
	else
...
KXCOMAPI ULONG STDMETHODCALLTYPE LanguageFactory_AddRef(
	IN	ILanguageFactory* This)
{
	return 1;
}

KXCOMAPI ULONG STDMETHODCALLTYPE LanguageFactory_Release(
	IN	ILanguageFactory* This)
{
	return 1;
}

KXCOMAPI HRESULT STDMETHODCALLTYPE LanguageFactory_GetIids(
	IN	ILanguageFactory* This,
	OUT	PULONG		NumberOfIids,
	OUT	IID** IidArray)
{
	...
	*NumberOfIids = Count;
	Array[0] = IID_ILanguageFactory;

	return S_OK;
}

KXCOMAPI HRESULT STDMETHODCALLTYPE LanguageFactory_GetRuntimeClassName(
	IN	ILanguageFactory* This,
	OUT	HSTRING* ClassName)
{
	PCWSTR Name = L"Windows.Globalization.ILanguageFactory";
	ASSERT(ClassName != NULL);
	return WindowsCreateString(Name, (ULONG)wcslen(Name), ClassName);
}

KXCOMAPI HRESULT STDMETHODCALLTYPE LanguageFactory_GetTrustLevel(
	IN	ILanguageFactory* This,
	OUT	TrustLevel* Level)
{
	ASSERT(Level != NULL);
...
KXCOMAPI HRESULT STDMETHODCALLTYPE LanguageFactory_CreateLanguage(
	IN ILanguageFactory* thiz,
	IN HSTRING tag,
	OUT ILanguage** out)
{
	if (out == NULL)
	...
	ILanguage* Lang = (ILanguage*)CoTaskMemAlloc(sizeof(ILanguage));
	if (Lang == NULL)
		return E_OUTOFMEMORY;

	CONST WCHAR* Name = WindowsGetStringRawBuffer(tag, NULL);
	if (!GetLocaleInfoEx(Name, LOCALE_SNAME, Lang->Name, ARRAYSIZE(Lang->Name)))
	{
		CoTaskMemFree(Lang);
		return E_INVALIDARG;
	}

	Lang->lpVtbl = &CLanguageVtbl;
	Lang->Parent = Lang;
	Lang->RefCount = 1;

	Lang->cLanguage2.lpVtbl = &CLanguage2Vtbl;
	Lang->cLanguage2.Parent = Lang;

	*out = Lang;
	return S_OK;
}

ILanguageFactoryVtbl CLanguageFactoryVtbl = {
	LanguageFactory_QueryInterface,
	LanguageFactory_AddRef,
	LanguageFactory_Release,
	LanguageFactory_GetIids,
	LanguageFactory_GetRuntimeClassName,
	LanguageFactory_GetTrustLevel,
	LanguageFactory_CreateLanguage
};

ILanguageFactory CLanguageFactory = {
	&CLanguageFactoryVtbl
};


// Windows.Globalization.IApplicationLanguagesStatics

KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_QueryInterface(
	IN	IApplicationLanguagesStatics* This,
	IN	REFIID		RefIID,
	OUT	PPVOID		Object)
{
	ASSERT(This != NULL);
	...
	*Object = NULL;
	...
	if (IsEqualIID(RefIID, &IID_IUnknown) ||
		IsEqualIID(RefIID, &IID_IInspectable) ||
		IsEqualIID(RefIID, &IID_IAgileObject) ||
		IsEqualIID(RefIID, &IID_IApplicationLanguagesStatics))
	{
		*Object = This;
	}
	else
...
KXCOMAPI ULONG STDMETHODCALLTYPE ApplicationLanguagesStatics_AddRef(
	IN	IApplicationLanguagesStatics* This)
{
	return 1;
}

KXCOMAPI ULONG STDMETHODCALLTYPE ApplicationLanguagesStatics_Release(
	IN	IApplicationLanguagesStatics* This)
{
	return 1;
}

KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_GetIids(
	IN	IApplicationLanguagesStatics* This,
	OUT	PULONG		NumberOfIids,
	OUT	IID** IidArray)
{
	...
	*NumberOfIids = Count;
	Array[0] = IID_IApplicationLanguagesStatics;

	return S_OK;
}

KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_GetRuntimeClassName(
	IN	IApplicationLanguagesStatics* This,
	OUT	HSTRING* ClassName)
{
	PCWSTR Name = L"Windows.Globalization.IApplicationLanguagesStatics";
	ASSERT(ClassName != NULL);
	return WindowsCreateString(Name, (ULONG)wcslen(Name), ClassName);
}

KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_GetTrustLevel(
	IN	IApplicationLanguagesStatics* This,
	OUT	TrustLevel* Level)
{
	ASSERT(Level != NULL);
...
KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_get_PrimaryLanguageOverride(
	IN IApplicationLanguagesStatics* thiz,
	OUT HSTRING* tag)
{
...
KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_put_PrimaryLanguageOverride(
	IN IApplicationLanguagesStatics* thiz,
	IN HSTRING tag)
{
	KexLogWarningEvent(L"Unimplemented function %s called", __FUNCTIONW__);
...
KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_get_Languages(
	IN IApplicationLanguagesStatics* thiz,
	OUT IVectorView_HSTRING** VectorView)
{
	if (VectorView == NULL)
	...
	return CGlobalizationPreferencesStatics_get_Languages(&CGlobalizationPreferencesStatics, VectorView);
}

KXCOMAPI HRESULT STDMETHODCALLTYPE ApplicationLanguagesStatics_get_ManifestLanguages(
	IN IApplicationLanguagesStatics* thiz,
	OUT IVectorView_HSTRING** tags)
{
	KexLogWarningEvent(L"Unimplemented function %s called", __FUNCTIONW__);
	return E_NOTIMPL;
}

IApplicationLanguagesStaticsVtbl CApplicationLanguagesStaticsVtbl = {
	ApplicationLanguagesStatics_QueryInterface,
	ApplicationLanguagesStatics_AddRef,
	ApplicationLanguagesStatics_Release,
	ApplicationLanguagesStatics_GetIids,
	ApplicationLanguagesStatics_GetRuntimeClassName,
	ApplicationLanguagesStatics_GetTrustLevel,
	ApplicationLanguagesStatics_get_PrimaryLanguageOverride,
	ApplicationLanguagesStatics_put_PrimaryLanguageOverride,
	ApplicationLanguagesStatics_get_Languages,
	ApplicationLanguagesStatics_get_ManifestLanguages
};

IApplicationLanguagesStatics CApplicationLanguagesStatics = {
	&CApplicationLanguagesStaticsVtbl
};